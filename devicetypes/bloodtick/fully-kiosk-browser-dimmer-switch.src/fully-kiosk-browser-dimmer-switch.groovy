 ...
 *
 *  Fully Kiosk Browser Dimmer Switch
...
metadata {
	definition (name: "Fully Kiosk Browser Dimmer Switch", namespace: "bloodtick", author: "SmartThings") {
	capability "Actuator"
	capability "Switch"
...
preferences {
	input(name:"deviceIp", type:"text", title: "Device IP Address", description: "Device IP Address", required: true, displayDuringSetup: true)
...
def setStringSetting(String key, String value) {
	def cmd = "?type=json&password=${devicePassword}&cmd=setStringSetting&key=${key}&value=${value}"
    addEvent(["setStringSetting", key, value, cmd])
}

def setBooleanSetting(String key, String value) {
    def cmd = "?type=json&password=${devicePassword}&cmd=setBooleanSetting&key=${key}&value=${value}"
...
def parse(String description) {
    ...
    if (msg.header!=null && msg.body!=null) {
        ...
        //log.debug "msg.header.requestId: '${msg}'"
...
private def decodePostResponse(body) {
...
/*
{ "foregroundApp": "de.ozerov.fully", "appVersionName": "1.29-fire", "ssid": "\"Olivia-5G\"", "appFreeMemory": 126354048, "batteryLevel": 100, "wifiSignalLevel": 9, "appUsedMemory": 7863680, 
"deviceManufacturer": "Amazon", "displayHeightPixels": 800, "totalUsedMemory": 1232932864, "ip4": "192.168.1.103", "displayWidthPixels": 1280, "androidVersion": "7.1.2", 
"kioskMode": false, "locationLongitude": -73.97143844515084, "deviceModel": "KFKAWI", "totalFreeMemory": 206925824, 
"currentPage": "https://app.actiontiles.com/panel/8c75a3fc-b8bd-4b0c-9c9e-a3deb2c30a0b", "deviceName": "KFKAWI", 
"isLicensed": true, "currentFragment": "screensaver", "locationAltitude": 0.0, "appVersionCode": 488, 
"webviewUa": "Mozilla/5.0 (Linux; Android 7.1.2; KFKAWI Build/NS6301; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/59.0.3071.125 Safari/537.36", 
"mac": "24:4C:E3:69:8F:66", "screenBrightness": 0, "androidSdk": "25", "locationLatitude": 40.78919797204434, 
"isDeviceOwner": false, "hostname4": "192.168.1.103", "ip6": "FE80::264C:E3FF:FE69:8F66", "currentTabIndex": 0, "deviceID": 
"74d4106e-7c814980", "isDeviceAdmin": true, "lastAppStart": "3/26/19 9:05:40 AM", "hostname6": "fe80::264c:e3ff:fe69:8f66%wlan0", 
"plugged": true, "motionDetectorState": 2, "maintenanceMode": false, "keyguardLocked": false, 
"startUrl": "https://app.actiontiles.com/panel/8c75a3fc-b8bd-4b0c-9c9e-a3deb2c30a0b", 
"isScreenOn": true, "screenOrientation": 270, "locationProvider": "network"
}

{ 
"mdmSystemUpdatePolicy": "0", "showMenuHint": false, "movementBeaconList": "", "authUsername": "", "motionSensitivity": "85", "remoteAdminPassword": "123456", "launchOnBoot": true, "touchInteraction": true, 
"showBackButton": true, "addressBarBgColor": -2236963, "mdmSystemAppsToEnable": "", "kioskWifiPin": "", "wifiSSID": "", "keepSleepingIfUnplugged": false, "microphoneAccess": false, "cacheMode": "-1", "screensaverBrightness": "0", 
"thirdPartyCookies": true, "desktopMode": false, "safeBrowsing": false, "screensaverOtherAppIntent": "", "disablePowerButton": true, "screensaverFullscreen": true, "inUseWhileKeyboardVisible": false, 
"actionBarTitle": "Fully Kiosk Browser", "pageTransitions": false, "urlBlacklist": "", "playAlarmSoundUntilPin": false, "showAppLauncherOnStart": false, "appLauncherScaling": "100", 
"usageStatistics": false, "restartOnCrash": true, "tabsFgColor": -16777216, "sleepOnPowerDisconnect": false, "remotePdfFileMode": "0", "keepOnWhileFullscreen": true, "mdmMinimumPasswordLength": "5", 
"deleteHistoryOnReload": false, "mdmApkToInstall": "", "autoplayVideos": true, "loadOverview": false, "startURL": "https://app.actiontiles.com/panel/8c75a3fc-b8bd-4b0c-9c9e-a3deb2c30a0b", 
"screensaverOtherApp": false, "showNewTabButton": false, "advancedKioskProtection": false, "mdmDisableKeyguard": false, "searchProviderUrl": "https://www.google.com/search?q\u003d", 
"defaultWebviewBackgroundColor": -1, "motionDetectionAcoustic": false, "reloadOnScreenOn": false, "knoxDisableMultiUser": false, "enableBackButton": false, "mdmDisableUsbStorage": false, 
"actionBarBgUrl": "", "setWifiWakelock": false, "lockSafeMode": false, "showTabCloseButtons": true, "knoxDisableMtp": false, "deleteWebstorageOnReload": false, "mdmAppsToDisable": "", 
"actionBarFgColor": -1, "audioRecordUploads": false, "fadeInOutDuration": "200", "autoplayAudio": false, "showPrintButton": false, "remoteAdminCamshot": false, "kioskExitGesture": "0", 
"kioskAppWhitelist": "", "remoteAdminScreenshot": true, "enableVersionInfo": false, "showShareButton": false, "recreateTabsOnReload": false, "injectJsCode": "", 
"screensaverWallpaperURL": "fully://color#000000", "forceScreenOrientation": "0", "showStatusBar": false, "appLauncherBackgroundColor": -1, "mdmAppLockTaskWhitelist": "", 
"webcamAccess": false, "playAlarmSoundOnMovement": false, "forceImmersive": false, "keepScreenOn": true, "showCamPreview": false, "pauseMotionInBackground": false, "timeToScreenOffV2": "0", 
"softKeyboard": true, "statusBarColor": 0, "fileUploads": false, "screensaverPlaylist": "", "showNavigationBar": false, "launcherApps": "", "autoImportSettings": true, "motionDetection": true, 
"cloudService": false, "websiteIntegration": false, "deleteCookiesOnReload": false, "errorURL": "", "scrollingDragging": true, "knoxDisableCamera": false, "knoxEnabled": false, "playMedia": false, 
"stopScreensaverOnMotion": true, "redirectBlocked": false, "mdmDisableADB": true, "showTabs": false, "restartAfterUpdate": true, "fontSize": "100", "clearCacheEach": false, "mdmDisableVolumeButtons": false, 
"confirmExit": true, "ignoreSSLerrors": false, "setRemoveSystemUI": false, "wifiKey": "", "screenOffInDarkness": false, "inactiveTabsBgColor": -4144960, "useWideViewport": true, 
"geoLocationAccess": false, "graphicsAccelerationMode": "2", "authPassword": "", "tabsBgColor": -2236963, "loadCurrentPageOnReload": true, "enablePullToRefresh": false, 
"motionSensitivityAcoustic": "90", "ignoreMotionWhenMoving": false, "actionBarCustomButtonUrl": "", "kioskHomeStartURL": false, "mdmRuntimePermissionPolicy": "0", 
"disableCamera": false, "darknessLevel": "10", "actionBarInSettings": false, "remoteAdminLan": true, "movementBeaconDistance": "5", "swipeTabs": false, "alarmSoundFileUrl": "", 
"knoxDisableStatusBar": false, "reloadOnInternet": true, "mdmLockTask": false, "timeToScreensaverV2": "90", "movementDetection": false, "sleepOnPowerConnect": false, 
"resumeVideoAudio": true, "readNfcTag": false, "swipeNavigation": false, "screenOnOnMovement": true, "timeToClearSingleAppData": "0", "timeToRegainFocus": "0", "knoxDisableUsbHostStorage": false, 
"actionBarBgColor": -15906911, "enableZoom": true, "reloadOnWifiOn": true, "compassSensitivity": "50", "touchesOtherAppsBreakIdle": false, "reloadPageFailure": "0", "actionBarIconUrl": "", "initialScale": "0", 
"errorUrlOnDisconnection": "0", "showHomeButton": true, "reloadEachSeconds": "0", "accelerometerSensitivity": "80", "knoxDisableScreenCapture": false, "forceScreenUnlock": false, "waitInternetOnReload": true, 
"disableVolumeButtons": true, "disableStatusBar": true, "kioskPin": "1234", "screensaverDaydream": false, "detectIBeacons": false, "stopScreensaverOnMovement": true, 
"videoCaptureUploads": false, "motionCameraId": "", "knoxDisableSafeMode": false, "urlWhitelist": "", "disableOtherApps": true, "progressBarColor": -13611010, "enableTapSound": true, 
"showActionBar": false, "volumeLicenseKey": "", "remoteAdmin": true, "mdmDisableSafeModeBoot": true, "launcherInjectCode": "", "cameraCaptureUploads": false, "sleepSchedule": "", 
"setCpuWakelock": false, "enablePopups": false, "mdmDisableStatusBar": false, "lastVersionInfo": "1.29-fire", "textSelection": true, "jsAlerts": true, "disableHomeButton": true, "webviewDebugging": false, 
"mdmDisableAppsFromUnknownSources": true, "showAddressBar": false, "playerCacheImages": true, "batteryWarning": "0", "localPdfFileMode": "0", "kioskMode": false, "mdmDisableScreenCapture": false, 
"singleAppMode": false, "enableUrlOtherApps": false, "mdmPasswordQuality": "0", "navigationBarColor": 0, "isRunning": true, "motionFps": "5", "reloadOnScreensaverStop": false, "customUserAgent": "", 
"screenBrightness": "191", "formAutoComplete": true, "showProgressBar": true, "showRefreshButton": false, "showForwardButton": true, "timeToClearLauncherAppData": "0", "enableFullscreenVideos": true, 
"remoteFileMode": "0", "userAgent": "0", "singleAppIntent": "", "runInForeground": false, "deleteCacheOnReload": false, "screenOnOnMotion": false
}
*/