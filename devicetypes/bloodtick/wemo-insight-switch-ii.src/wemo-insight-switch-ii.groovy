...
def decodeInsightResponse( String[] params ) {
	...
	if(returnLastState && device.currentValue("switch")=="offline" && state.lastState!="off" && value=="off") {
...
def setOffline() {
	...
	sendEvent(name: "status", value: "offline", displayed: false, isStateChange: true)
